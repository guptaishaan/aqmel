...
non_wildfire_stats = pd.read_csv('/Users/ishaangupta/Downloads/main/assderp/jorgensen-v5/pose-detection-keypoints-estimation-yolov8/aqmel/wildfire_stats.csv')
wildfire_stats = pd.read_csv('/Users/ishaangupta/Downloads/main/assderp/jorgensen-v5/pose-detection-keypoints-estimation-yolov8/aqmel/non_wildfire_stats.csv')
...
# Non-Wildfire Data
plt.plot(non_wildfire_stats['Hour'], non_wildfire_stats['Mean PM2.5'], label='Non-Wildfire Mean PM2.5', color='blue', marker='o')
...
# Wildfire Data
plt.plot(wildfire_stats['Hour'], wildfire_stats['Mean PM2.5'], label='Wildfire Mean PM2.5', color='red', marker='o')
